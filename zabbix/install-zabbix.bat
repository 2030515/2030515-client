:: Установка и настройка заббикса. При установке требуется правильно заполнить параметры Server и ServerActive
:: Проверено - работает
:: Не до конца разобрался с AllowKey и EnableRemoteCommnads. Сейчас настроено - все можно.
